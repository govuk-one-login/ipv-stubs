...
public class CriStubDataAddress {
    ...
    public static final List<IdentityCheckSubjectCriStubData> Data =
            List.of(
                    ...
                    createData(
                            "Alice Parker (Changed Address) Valid Address",
                    ...
                    createData(
                            "James Moriarty (Invalid) Address",
                    ...
                    createData(
                            "Kenneth Decerqueira (Valid Experian) Address",
                            Addresses.KENNETH_DECERQUERIA_ADDRESS),
                    createData(
                            "Kenneth Decerqueira (Changed Address) Address",
                            Addresses.KENNETH_DECERQUERIA_OLD_ADDRESS,
                            Addresses.KENNETH_DECERQUERIA_NEW_ADDRESS),
                    createData(
                            "Kenneth Decerqueira (International) Address",
    ...
    private static IdentityCheckSubjectCriStubData createData(String label, PostalAddress address) {
        return IdentityCheckSubjectCriStubData.builder()
                .label(label)
                .payload(IdentityCheckSubject.builder().withAddress(List.of(address)).build())
                .build();
    }

    private static IdentityCheckSubjectCriStubData createData(
            String label, PostalAddress address1, PostalAddress address2) {
        return IdentityCheckSubjectCriStubData.builder()
                .label(label)
                .payload(
