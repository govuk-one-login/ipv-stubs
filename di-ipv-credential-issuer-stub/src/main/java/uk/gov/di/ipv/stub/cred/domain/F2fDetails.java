...
import static uk.gov.di.ipv.stub.cred.handlers.RequestParamConstants.F2F_QUEUE_SUBJECT_JSON;
...
public record F2fDetails(
        boolean sendVcToQueue,
        boolean sendErrorToQueue,
        String queueName,
        Integer delaySeconds,
        String queueSubjectJson) {
    ...
    public static F2fDetails fromFormContext(Context ctx) {
        return new F2fDetails(
                ...
                null,
                ctx.formParam(F2F_QUEUE_SUBJECT_JSON));
    }
}
