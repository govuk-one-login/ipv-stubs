...
public class CriStubDataClaimedIdentity {
    ...
    public static final List<IdentityCheckSubjectCriStubData> Data =
            List.of(
                    ...
                    createData("Claire Aarts (DWP)", Names.Claire_Aarts, BirthDates.CLAIRE_AARTS),
                    ...
                    createData("Kabir Singh (DWP)", Names.Kabir_Singh, BirthDates.KABIR_SINGH),
                    createData(
                            "Kenneth Decerqueira",
                            Names.Kenneth_Decerqueira,
                            BirthDates.KENNETH_DECERQUEIRA),
                    createData("Mary Watson", Names.Mary_Watson, BirthDates.MARY_WATSON),
                    createData("Nora Porter (DWP)", Names.Nora_Porter, BirthDates.NORA_PORTER),
                    createData("Saul Goodman", Names.SAUL_GOODMAN, BirthDates.SAUL_GOODMAN),
                    createData("Tom Hardy (DWP)", Names.Tom_Hardy, BirthDates.TOM_HARDY));
