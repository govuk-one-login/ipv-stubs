...
public class IdCards {
    ...
    public static final IdCardDetails EEA_VALID =
            createIdCard("NLD", "SPEC12031", "2021-08-02", "2031-08-02");
    ...
    private static IdCardDetails createIdCard(
            String icaoIssuerCode, String documentNumber, String issueDate, String expiryDate) {
