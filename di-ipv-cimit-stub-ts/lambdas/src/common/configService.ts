...
export const getCimitSigningKey = async () => getSsmParameter(process.env.CIMIT_PARAM_BASE_PATH + CIMIT_SIGNING_KEY_PARAM);
const CIMIT_COMPONENT_ID_PARAM = "componentId";
export const getCimitComponentId = async () => getSsmParameter(process.env.CIMIT_PARAM_BASE_PATH + CIMIT_COMPONENT_ID_PARAM);