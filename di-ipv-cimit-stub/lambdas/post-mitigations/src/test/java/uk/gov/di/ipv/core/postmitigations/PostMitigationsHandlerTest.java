...
class PostMitigationsHandlerTest {
    ...
    void shouldReturnFailureWhenProvidedInvalidVCs() throws IOException {
        ...
        var expectedResponse =
                mapper.writeValueAsString(new PostMitigationsResponse(FAILURE_RESPONSE));
    ...
    void shouldReturnFailureWhenProvidedInValidRequest() throws IOException {
        var response =
                makeRequest(postMitigationsHandler, mapper.writeValueAsString(""), mockContext);
    ...
    void shouldCompletePendingMitigations() throws Exception {
        ...
        var expectedResponse =
                mapper.writeValueAsString(new PostMitigationsResponse(SUCCESS_RESPONSE));
        assertEquals(expectedResponse, response);
    }

    private String makeRequest(RequestStreamHandler handler, String request, Context context)
            throws IOException {
