...
class PostMitigationsHandlerTest {
    ...
    void shouldReturnFailureWhenProvidedInvalidVCs() throws Exception {
        ...
        request.setBody(mapper.writeValueAsString(
                PostMitigationsRequestBodyDto.builder().signedJwtVcs(List.of("invalid_signed_jwt")).build()));
    ...
    @Test
    void shouldReturnFailureWhenIpAddressNotProvided() throws Exception {
        var request = new APIGatewayProxyRequestEvent();
        request.setHeaders(Map.of("govuk-signin-journey-id", "journeyId"));
        request.setBody(mapper.writeValueAsString(
                PostMitigationsRequestBodyDto.builder().signedJwtVcs(List.of(VALID_JWT)).build()));
    ...
    @Test
    void shouldReturnFailureWhenBodyIsInvalid() throws IOException {
        var request = new APIGatewayProxyRequestEvent();
        request.setHeaders(Map.of("govuk-signin-journey-id", "journeyId", "ip-address", "ip-address"));
        request.setBody("");
    ...
    @Test
    void shouldReturnFailureWhenJourneyIdNotProvided() throws IOException {
        var request = new APIGatewayProxyRequestEvent();
        request.setHeaders(Map.of("ip-address", "ip-address"));
        request.setBody(mapper.writeValueAsString(
                PostMitigationsRequestBodyDto.builder().signedJwtVcs(List.of(VALID_JWT)).build()));
    ...
    void shouldCompletePendingMitigations() throws Exception {
        ...
        request.setHeaders(Map.of("govuk-signin-journey-id", "journeyId", "ip-address", "ip-address"));
        request.setBody(mapper.writeValueAsString(
                PostMitigationsRequestBodyDto.builder().signedJwtVcs(
                        List.of(
