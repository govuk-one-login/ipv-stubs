...
public record JarUserInfo(
        @JsonProperty(value = "https://vocab.account.gov.uk/v1/coreIdentityJWT") Essential coreIdentityJwtClaim,
        ...
        @JsonProperty(value = "https://vocab.account.gov.uk/v1/socialSecurityNumber") Essential ninoClaim,
