...
public class JwtBuilder {
    ...
    private static RSAKey getEncryptionKey(String targetEnvironment) throws ParseException {
        return switch (targetEnvironment) {
            case ("DEV"), ("DEV_AMRITS"), ("DEV_ALIR"), ("DEV_PATRICKB") -> RSAKey.parse(ORCHESTRATOR_DEV01_JAR_ENCRYPTION_PUBLIC_JWK);
            case ("PERF"), ("DEV_DANC"), ("DEV_JOEE"), ("DEV_MIKEC"), ("DEV_DOMINIKT"), ("DEV_THEAB") -> RSAKey.parse(ORCHESTRATOR_DEV02_JAR_ENCRYPTION_PUBLIC_JWK);
