            ...
            (Request request, Response response) -> {
                ...
                var authRequest =
                        new AuthorizationRequest.Builder(
                                ...
                                .redirectionURI(new URI("https://orch-dev-mikec.02.core.dev.stubs.account.gov.uk/callback"))
                                .endpointURI(new URI("https://dev-mikec.02.dev.identity.account.gov.uk/").resolve("/oauth2/authorize"))
